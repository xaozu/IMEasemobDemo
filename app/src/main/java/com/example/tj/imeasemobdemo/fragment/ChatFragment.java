...
import com.example.tj.imeasemobdemo.activity.ContextMenuActivity;
import com.example.tj.imeasemobdemo.activity.MainActivity;
import com.example.tj.imeasemobdemo.activity.PickAtUserActivity;
...
//        startActivity(intent);
        ToastUtils.showDefault("头像点击 "+username);
    }
